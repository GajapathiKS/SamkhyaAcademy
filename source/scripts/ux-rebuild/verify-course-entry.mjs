...
const examples={86:[87,112],88:[89,113],6:[82,83,84],90:[91,92]};
...
for(const n of [4,5,11,12,13,14,15,16,17,86,88,90,6,102]){
 ...
 if(n!==86&&n!==88&&n!==90&&n!==6&&n!==102){
  await page.getByRole('link',{name:'Open sample text lesson',exact:true}).click();
...
await browser.close();console.log('PASS 14 course pages: format access and mobile width');
